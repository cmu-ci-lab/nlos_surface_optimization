function [x, y, depth, albedo, vol] = cnlos(transient_location, transient_location2)
...
if exist('transient_location2','var')
  load (transient_location2);
  gt_transient = m_transient;
end
bin_resolution = 1.2*10^-3/c; % Data simulated with 8 ps bin resolution.
z_offset = 0;
...
N = sqrt(size(gt_transient,1));
rect_data = reshape(gt_transient, N, N, size(gt_transient,2));
