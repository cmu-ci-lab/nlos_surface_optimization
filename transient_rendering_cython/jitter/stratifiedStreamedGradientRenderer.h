...
void streamed_render_gradient_w_albedo(double* data, double* weight, float* originD, int measurement, float* normalD, float* verticesD, int numVertices, float* albedo, int* trianglesD, int numTriangles, int numSamples, float pathlengthLowerBound, float pathlengthUpperBound, float pathlengthResolution, double* jitter_weight, int weight_offset, int weight_length, double* transient, double *pathlengths, double* gradient, int refine_scale, int sigma_bin, int testing_flag, int loss_test);
*/
void streamed_render_gradient(double* data, double* weight, float* originD, int measurement, float* normalD, float* verticesD, int numVertices, float* vertexNormal, int* trianglesD, int numTriangles, int numSamples, float pathlengthLowerBound, float pathlengthUpperBound, float pathlengthResolution, double* jitter_weight, double* jitter_grad, int weight_offset, int weight_length, double* transient, double *pathlengths, double* gradient, int testing_flag);
/*
