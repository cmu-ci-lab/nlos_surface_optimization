...
scipy.io.savemat(filename, mdict={'v':mesh.v.data.numpy(), 'f':mesh.f.data.numpy(),'lighting':lighting, 'direction':direction, 'angular_transient':angular_transient.data.numpy(),'grad':grad.data.numpy()})
